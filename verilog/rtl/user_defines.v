...
// Deliberately erroneous placeholder value.  It remains defined for reference,
// but every user-configurable GPIO below is assigned a valid mode.
...
// The NTT is controlled through Wishbone and does not drive GPIOs.  Match the
// wrapper's io_oeb=1 behavior by bringing every user GPIO up as a digital user
// input without a pull resistor.  Firmware may reconfigure them later.
