...
entity kyber_mult_start_for_basemul_all_U0 is 
    generic (
...
architecture rtl of kyber_mult_start_for_basemul_all_U0 is

    component kyber_mult_start_for_basemul_all_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_kyber_mult_start_for_basemul_all_U0_ShiftReg : kyber_mult_start_for_basemul_all_U0_ShiftReg
    generic map (
...
entity kyber_mult_start_for_basemul_all_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end kyber_mult_start_for_basemul_all_U0_ShiftReg;

architecture rtl of kyber_mult_start_for_basemul_all_U0_ShiftReg is
