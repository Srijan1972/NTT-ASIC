...
set C_modelArgList {
	...
	{ b int 64 regular  }
	{ sA0 int 192 regular {fifo 1 volatile }  }
	{ sB0 int 192 regular {fifo 1 volatile }  }
	{ batch int 32 regular  }
	{ batch_size_c15 int 32 regular {fifo 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "a","offset": { "type": "dynamic","port_name": "a","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "sA0", "interface" : "fifo", "bitwidth" : 192, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sB0", "interface" : "fifo", "bitwidth" : 192, "direction" : "WRITEONLY"} , 
 	{ "Name" : "batch", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "batch_size_c15", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sA0_din sc_out sc_lv 192 signal 4 } 
	{ sA0_num_data_valid sc_in sc_lv 6 signal 4 } 
	{ sA0_fifo_cap sc_in sc_lv 6 signal 4 } 
	{ sA0_full_n sc_in sc_logic 1 signal 4 } 
	{ sA0_write sc_out sc_logic 1 signal 4 } 
	{ sB0_din sc_out sc_lv 192 signal 5 } 
	{ sB0_num_data_valid sc_in sc_lv 6 signal 5 } 
	{ sB0_fifo_cap sc_in sc_lv 6 signal 5 } 
	{ sB0_full_n sc_in sc_logic 1 signal 5 } 
	{ sB0_write sc_out sc_logic 1 signal 5 } 
	{ batch sc_in sc_lv 32 signal 6 } 
	{ batch_size_c15_din sc_out sc_lv 32 signal 7 } 
	{ batch_size_c15_num_data_valid sc_in sc_lv 3 signal 7 } 
	{ batch_size_c15_fifo_cap sc_in sc_lv 3 signal 7 } 
	{ batch_size_c15_full_n sc_in sc_logic 1 signal 7 } 
	{ batch_size_c15_write sc_out sc_logic 1 signal 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sA0_din", "direction": "out", "datatype": "sc_lv", "bitwidth":192, "type": "signal", "bundle":{"name": "sA0", "role": "din" }} , 
 	...
 	{ "name": "sA0_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sA0", "role": "full_n" }} , 
 	{ "name": "sA0_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sA0", "role": "write" }} , 
 	{ "name": "sB0_din", "direction": "out", "datatype": "sc_lv", "bitwidth":192, "type": "signal", "bundle":{"name": "sB0", "role": "din" }} , 
 	...
 	{ "name": "sB0_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sB0", "role": "full_n" }} , 
 	{ "name": "sB0_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sB0", "role": "write" }} , 
 	{ "name": "batch", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "batch", "role": "default" }} , 
 	{ "name": "batch_size_c15_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "batch_size_c15", "role": "din" }} , 
 	{ "name": "batch_size_c15_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "batch_size_c15", "role": "num_data_valid" }} , 
 	{ "name": "batch_size_c15_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "batch_size_c15", "role": "fifo_cap" }} , 
 	{ "name": "batch_size_c15_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "batch_size_c15", "role": "full_n" }} , 
 	{ "name": "batch_size_c15_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "batch_size_c15", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_load_all_Pipeline_LD_BLK_LD_fu_106", "Port" : "gmem0", "Inst_start_state" : "10", "Inst_end_state" : "11"}]},
			{"Name" : "a", "Type" : "None", "Direction" : "I"},
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "gmem1_blk_n_AR", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_load_all_Pipeline_LD_BLK_LD_fu_106", "Port" : "gmem1", "Inst_start_state" : "10", "Inst_end_state" : "11"}]},
			{"Name" : "b", "Type" : "None", "Direction" : "I"},
			{"Name" : "sA0", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "32", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_load_all_Pipeline_LD_BLK_LD_fu_106", "Port" : "sA0", "Inst_start_state" : "10", "Inst_end_state" : "11"}]},
			{"Name" : "sB0", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "32", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_load_all_Pipeline_LD_BLK_LD_fu_106", "Port" : "sB0", "Inst_start_state" : "10", "Inst_end_state" : "11"}]},
			{"Name" : "batch", "Type" : "None", "Direction" : "I"},
			{"Name" : "batch_size_c15", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "batch_size_c15_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_load_all_Pipeline_LD_BLK_LD_fu_106", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_load_all_Pipeline_LD_BLK_LD_fu_106.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "269", "Max" : "4109"}
	, {"Name" : "Interval", "Min" : "269", "Max" : "4109"}
]}
...
set Spec2ImplPortList { 
	...
	sA0 { ap_fifo {  { sA0_din fifo_data_in 1 192 }  { sA0_num_data_valid fifo_status_num_data_valid 0 6 }  { sA0_fifo_cap fifo_update 0 6 }  { sA0_full_n fifo_status 0 1 }  { sA0_write fifo_port_we 1 1 } } }
	sB0 { ap_fifo {  { sB0_din fifo_data_in 1 192 }  { sB0_num_data_valid fifo_status_num_data_valid 0 6 }  { sB0_fifo_cap fifo_update 0 6 }  { sB0_full_n fifo_status 0 1 }  { sB0_write fifo_port_we 1 1 } } }
	batch { ap_none {  { batch in_data 0 32 } } }
	batch_size_c15 { ap_fifo {  { batch_size_c15_din fifo_data_in 1 32 }  { batch_size_c15_num_data_valid fifo_status_num_data_valid 0 3 }  { batch_size_c15_fifo_cap fifo_update 0 3 }  { batch_size_c15_full_n fifo_status 0 1 }  { batch_size_c15_write fifo_port_we 1 1 } } }
}
