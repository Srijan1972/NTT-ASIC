...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_sA0 \
    op interface \
    ports { sA0_din { O 192 vector } sA0_num_data_valid { I 6 vector } sA0_fifo_cap { I 6 vector } sA0_full_n { I 1 bit } sA0_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_sB0 \
    op interface \
    ports { sB0_din { O 192 vector } sB0_num_data_valid { I 6 vector } sB0_fifo_cap { I 6 vector } sB0_full_n { I 1 bit } sB0_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_batch_size_c15 \
    op interface \
    ports { batch_size_c15_din { O 32 vector } batch_size_c15_num_data_valid { I 3 vector } batch_size_c15_fifo_cap { I 3 vector } batch_size_c15_full_n { I 1 bit } batch_size_c15_write { O 1 bit } } \
} "
}
