...
set C_modelName {store_all}
set C_modelType { void 0 }
set C_modelArgList {
	{ sC1 int 192 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "sC1", "interface" : "fifo", "bitwidth" : 192, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sC1_dout sc_in sc_lv 192 signal 0 } 
	{ sC1_num_data_valid sc_in sc_lv 6 signal 0 } 
	{ sC1_fifo_cap sc_in sc_lv 6 signal 0 } 
	{ sC1_empty_n sc_in sc_logic 1 signal 0 } 
	{ sC1_read sc_out sc_logic 1 signal 0 } 
	...
	{ c_num_data_valid sc_in sc_lv 4 signal 2 } 
	{ c_fifo_cap sc_in sc_lv 4 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sC1_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":192, "type": "signal", "bundle":{"name": "sC1", "role": "dout" }} , 
 	...
 	{ "name": "sC1_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sC1", "role": "empty_n" }} , 
 	{ "name": "sC1_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sC1", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "sC1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "32", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_store_all_Pipeline_ST_BLK_ST_fu_77", "Port" : "sC1", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "gmem2_blk_n_AW", "Type" : "RtlSignal"},
					{"Name" : "gmem2_blk_n_B", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_store_all_Pipeline_ST_BLK_ST_fu_77", "Port" : "gmem2", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "c", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "6", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_store_all_Pipeline_ST_BLK_ST_fu_77", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_store_all_Pipeline_ST_BLK_ST_fu_77.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "267", "Max" : "4107"}
	, {"Name" : "Interval", "Min" : "267", "Max" : "4107"}
]}
...
set Spec2ImplPortList { 
	sC1 { ap_fifo {  { sC1_dout fifo_data_in 0 192 }  { sC1_num_data_valid fifo_status_num_data_valid 0 6 }  { sC1_fifo_cap fifo_update 0 6 }  { sC1_empty_n fifo_status 0 1 }  { sC1_read fifo_port_we 1 1 } } }
