...
set id 1200
set name kyber_mult_mac_mul_sub_14s_12ns_32s_32_3_1
...
set ce_signed 0
set out_width 32
set arg_lists {i0 {14 1 +} i1 {12 0 +} m {26 1 +} i2 {32 1 -} p {32 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kyber_mult_inv_stage_t_2_s_p_ZL5INV_W_0_0_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kyber_mult_inv_stage_t_2_s_p_ZL6INV_MW_0_0_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kyber_mult_inv_stage_t_2_s_p_ZL5INV_W_2_0_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kyber_mult_inv_stage_t_2_s_p_ZL6INV_MW_2_0_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
