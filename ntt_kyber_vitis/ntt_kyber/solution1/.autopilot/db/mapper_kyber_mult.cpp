...
using hls::sim::Byte;
extern "C" void kyber_mult(Byte<4>*, Byte<4>*, Byte<4>*, int, int, int, int);
extern "C" void apatb_kyber_mult_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_c, int __xlx_apatb_param_batch_size) {
...
__xlx_c__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_c)[i]);
  ...
  // DUT call
  kyber_mult(__xlx_a__tmp_vec.data(), __xlx_b__tmp_vec.data(), __xlx_c__tmp_vec.data(), __xlx_offset_byte_param_a, __xlx_offset_byte_param_b, __xlx_offset_byte_param_c, __xlx_apatb_param_batch_size);
