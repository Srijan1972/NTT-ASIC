set moduleName ntt_kernel_Pipeline_BUTTERFLY_LOOP
set isTopModule 0
...
set C_modelName {ntt_kernel_Pipeline_BUTTERFLY_LOOP}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem2 int 32 regular {axi_master 0}  }
	{ length_r int 32 regular  }
	{ sext_ln85 int 62 regular  }
	{ local_x int 32 regular {array 65536 { 1 2 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "twiddles","offset": { "type": "dynamic","port_name": "twiddles","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "sext_ln85", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "local_x", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
...
set portList { 
	...
	{ sext_ln85 sc_in sc_lv 62 signal 2 } 
	{ local_x_address0 sc_out sc_lv 16 signal 3 } 
	{ local_x_ce0 sc_out sc_logic 1 signal 3 } 
	{ local_x_q0 sc_in sc_lv 32 signal 3 } 
	{ local_x_address1 sc_out sc_lv 16 signal 3 } 
	{ local_x_ce1 sc_out sc_logic 1 signal 3 } 
	{ local_x_we1 sc_out sc_logic 1 signal 3 } 
	{ local_x_d1 sc_out sc_lv 32 signal 3 } 
	{ local_x_q1 sc_in sc_lv 32 signal 3 } 
	{ empty_23 sc_in sc_lv 16 signal 4 } 
	{ empty sc_in sc_lv 16 signal 5 } 
	{ q_inv sc_in sc_lv 32 signal 6 } 
	{ conv5_i sc_in sc_lv 32 signal 7 } 
	{ q sc_in sc_lv 32 signal 8 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln85", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln85", "role": "default" }} , 
 	...
 	{ "name": "local_x_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "local_x", "role": "address1" }} , 
 	{ "name": "local_x_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "local_x", "role": "ce1" }} , 
 	{ "name": "local_x_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "local_x", "role": "we1" }} , 
 	{ "name": "local_x_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "local_x", "role": "d1" }} , 
 	{ "name": "local_x_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "local_x", "role": "q1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_1_1_U8", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_32_1_1_U9", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "9", "Max" : "98310"}
	, {"Name" : "Interval", "Min" : "9", "Max" : "98310"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln85 { ap_none {  { sext_ln85 in_data 0 62 } } }
	local_x { ap_memory {  { local_x_address0 mem_address 1 16 }  { local_x_ce0 mem_ce 1 1 }  { local_x_q0 mem_dout 0 32 }  { local_x_address1 MemPortADDR2 1 16 }  { local_x_ce1 MemPortCE2 1 1 }  { local_x_we1 MemPortWE2 1 1 }  { local_x_d1 MemPortDIN2 1 32 }  { local_x_q1 MemPortDOUT2 0 32 } } }
