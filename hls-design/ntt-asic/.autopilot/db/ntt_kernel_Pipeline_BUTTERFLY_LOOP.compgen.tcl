...
set name ntt_kernel_mul_32ns_32ns_64_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}


set name ntt_kernel_mul_32s_32s_32_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename local_x \
    op interface \
    ports { local_x_address0 { O 16 vector } local_x_ce0 { O 1 bit } local_x_q0 { I 32 vector } local_x_address1 { O 16 vector } local_x_ce1 { O 1 bit } local_x_we1 { O 1 bit } local_x_d1 { O 32 vector } local_x_q1 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'local_x'"
}
}
