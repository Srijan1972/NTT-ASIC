...
set C_modelArgList {
	...
	{ phi_mul1 int 32 regular  }
	{ x int 64 regular  }
	{ local_x int 32 regular {array 65536 { 3 0 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "psi_powers","offset": { "type": "dynamic","port_name": "psi_powers","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "x","offset": { "type": "dynamic","port_name": "x","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "n", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln70", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "phi_mul1", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "x", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "local_x", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sext_ln70 sc_in sc_lv 62 signal 3 } 
	{ phi_mul1 sc_in sc_lv 32 signal 4 } 
	{ x sc_in sc_lv 64 signal 5 } 
	{ local_x_address1 sc_out sc_lv 16 signal 6 } 
	{ local_x_ce1 sc_out sc_logic 1 signal 6 } 
	{ local_x_we1 sc_out sc_logic 1 signal 6 } 
	{ local_x_d1 sc_out sc_lv 32 signal 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "phi_mul1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "phi_mul1", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "269", "Max" : "65549"}
	, {"Name" : "Interval", "Min" : "269", "Max" : "65549"}
]}
...
set Spec2ImplPortList { 
	...
	phi_mul1 { ap_none {  { phi_mul1 in_data 0 32 } } }
	x { ap_none {  { x in_data 0 64 } } }
	local_x { ap_memory {  { local_x_address1 MemPortADDR2 1 16 }  { local_x_ce1 MemPortCE2 1 1 }  { local_x_we1 MemPortWE2 1 1 }  { local_x_d1 MemPortDIN2 1 32 } } }
}
