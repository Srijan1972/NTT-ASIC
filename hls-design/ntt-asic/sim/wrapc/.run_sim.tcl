...
# 
# ==============================================================
set ::env(LD_LIBRARY_PATH) /eda/xilinx/Vitis_HLS/2023.2/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /eda/xilinx/Vitis_HLS/2023.2/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /eda/xilinx/Vitis_HLS/2023.2/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /eda/xilinx/Vitis_HLS/2023.2/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ntt_kernel.autotvin.dat"
	set constFileTvOut       "ntt_kernel.autotvout.dat"
	set constFileHdlTvIn     "ntt_kernel.autohdltvin.dat"
	set constFileHdlTvOut    "ntt_kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
