...
$(ObjDir)/ntt-test.cpp_pre.cpp.tb.o : ntt-test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ntt-test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/ntt-kernel.cpp_pre.cpp.tb.o : ntt-kernel.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ntt-kernel.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
